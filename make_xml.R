...
# Fix meta data
rjh[[1]][[1]][1]$title[[1]] <- "Zhenkun Li"
rjh[[1]][[1]][2]$link[[1]] <- "https://zhenkunli.com"
attr(rjh[[1]][[1]][3]$link, "href") <- "https://zhenkunli.com/index.xml"
rjh[[1]][[1]][4]$description[[1]] <- "Recent content by Zhnekun Li"
